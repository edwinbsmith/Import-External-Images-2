...
function si_external_images_import_all(posts,next_post) {
    ...
    if (current_time > ( window.si_import_images_start_time + 60000 ) && window.si_import_images_one_minute != 'set') {
        target_message.prepend('<div>1 minute passed... Looking good!</div>');
        window.si_import_images_one_minute = 'set';
    }
    if (current_time > ( window.si_import_images_start_time + 180000 ) && window.si_import_images_three_minute != 'set') {
        target_message.prepend('<div>3 minutes passed... Still looking good!</div>');
        window.si_import_images_three_minute = 'set';
    }
    if (current_time > ( window.si_import_images_start_time + 300000 ) && window.si_import_images_five_minute != 'set') {
        ...
        window.si_import_images_five_minute = 'set';
    }
    if (current_time > ( window.si_import_images_start_time + 600000 ) && window.si_import_images_ten_minute != 'set') {
        target_message.prepend('<div>10 minutes have passed... Woah! You have lot of images.</div>');
        window.si_import_images_ten_minute = 'set';
        var lets_stop_here = true;
    }
    if (current_time > ( window.si_import_images_start_time + 1200000 ) && window.si_import_images_twenty_minute != 'set') {
        ...
        window.si_import_images_twenty_minute = 'set';
    }
    ...
    if (window.si_import_images_twenty_minute != 'set') {
